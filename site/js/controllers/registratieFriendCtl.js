myapp.controller('registratieFriendCtl', ['$scope', '$http','$location','$cookies','$cookieStore', '$rootScope','$stateParams',function ($scope, $http, $location,$cookies,$cookieStore,$rootScope,$stateParams) {
...
$scope.submitForm = function() {
  ...
  registratie.ReferredByReferralCode = $stateParams.token;
